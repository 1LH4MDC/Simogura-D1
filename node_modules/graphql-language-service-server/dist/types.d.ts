...
declare type LineNumber = string;
declare type CharacterNumber = string;
declare type RelayLSPLocateCommand = (projectName: string, typeName: string, info: AdditionalLocateInfo) => `${string}:${LineNumber}:${CharacterNumber}` | `${string}:${LineNumber}` | string;
